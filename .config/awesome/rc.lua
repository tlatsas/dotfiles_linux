...
-- {{{ we use nitrogen to se the wallpaper
...
vicious.register(bat_widget, vicious.widgets.bat, "bat: $2%", 61, "BAT0")


-- temp
tmp_widget = wibox.widget.textbox()
vicious.register(tmp_widget, vicious.widgets.thermal, " - $1°C", 15, { "coretemp.0", "core"} )
